...
if [ "$color_prompt" = yes ]; then
    PS1="$COLOR_USERNAME$TEXT_USERNAME$RESET at $COLOR_HOSTNAME$TEXT_HOSTNAME$RESET in $COLOR_WORKING_DIRECTORY$TEXT_WORKING_DIRECTORY$RESET\$(__git_prompt)$RESET\n$ "
else
    PS1="$TEXT_USERNAME at $TEXT_HOSTNAME in $TEXT_WORKING_DIRECTORY\$(__git_prompt)\n$ "
fi
